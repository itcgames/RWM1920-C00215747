...
public class Spring : MonoBehaviour
{
    ...
    private bool SpringInputActive
    {
        get
        {
    ...
    void Update()
    {
        ...
        RaycastHit2D hit = Physics2D.Raycast(rayCastStart.position, Vector2.right, rayCastDistance, layerMask);
        ...
        else if (hit.collider != null /*&& animator.GetBool("Pressing")*/ && SpringInputActive)
        {
